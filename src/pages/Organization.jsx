      ...
      <div className="max-w-5xl mx-auto">
        ...
        <header className="mb-10 border-b border-slate-800 pb-8">
          ...
          <p className="text-lg text-slate-400 max-w-3xl">
            ...
            mapeamento da pasta pessoal do usuário "caninos" com foco no projeto
...
└── `}
        ...
        <div className="mt-12 bg-slate-800/50 rounded-xl p-8 border border-slate-700">
          ...
          <p className="text-slate-400 leading-relaxed mb-4">
            Este diretório representa a raiz do usuário <strong>caninos</strong>{" "}
            no sistema operacional embarcado. O projeto de visão computacional
            fica centralizado em{" "}
          ...
          <p className="text-slate-400 leading-relaxed">
            ...
            ligado, registrando possíveis falhas no{" "}
